...
export const createProduct = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    // Ensure WarehouseId matches authenticated Warehouse
    if (productData.WarehouseId && productData.WarehouseId !== WarehouseId) {
    ...
    // Checking WarehouseAddProduct.tsx sending taxId -> formData.tax
...
export const deleteProduct = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    console.log("DEBUG deleteProduct: WarehouseId from token:", WarehouseId);
...
/**
 * Get all active shops (for Warehouse to select when creating shop-by-store-only products)
 */
