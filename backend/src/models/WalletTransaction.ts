...
export interface IWalletTransaction extends Document {
    ...
    userType: 'Warehouse' | 'DELIVERY_BOY' | 'CUSTOMER' | 'horeca' | 'retailer'; // Type of user
    amount: number;
    type: 'Credit' | 'Debit';
    description: string;
...
const WalletTransactionSchema = new Schema<IWalletTransaction>(
    {
        ...
        userType: {
            type: String,
            enum: ['Warehouse', 'DELIVERY_BOY', 'CUSTOMER', 'horeca', 'retailer'],
...
const WalletTransaction = (mongoose.models.WalletTransaction as mongoose.Model<IWalletTransaction>) || mongoose.model<IWalletTransaction>('WalletTransaction', WalletTransactionSchema);
