                    ...
                    >
                        ...
                        <div className="flex gap-3 mt-1">
                            ...
                            <motion.a href="https://www.instagram.com/inorfresh" target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.1 }} aria-label="Instagram"
                                className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-[#009999] hover:bg-gradient-to-br hover:from-[#f09433] hover:via-[#e6683c] hover:to-[#dc2743] hover:text-white hover:border-transparent transition-all duration-300">
                            ...
                            {/* WhatsApp */}
                            <motion.a href="https://wa.me/919481214922" target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.1 }} aria-label="WhatsApp"
                                className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-[#009999] hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-all duration-300">
                                <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            {/* YouTube */}
                            <motion.a href="https://www.youtube.com/@inorfresh" target="_blank" rel="noopener noreferrer" whileHover={{ scale: 1.1 }} aria-label="YouTube"
                                className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-[#009999] hover:bg-[#FF0000] hover:text-white hover:border-[#FF0000] transition-all duration-300">
                                <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
