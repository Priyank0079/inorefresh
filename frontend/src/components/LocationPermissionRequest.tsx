...
export default function LocationPermissionRequest({
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-md z-[9999] flex flex-col items-center justify-center p-4 overflow-y-auto overflow-x-hidden">
      <div className="my-auto bg-white rounded-[32px] shadow-2xl max-w-sm w-full p-8 animate-in fade-in zoom-in duration-300 relative">
