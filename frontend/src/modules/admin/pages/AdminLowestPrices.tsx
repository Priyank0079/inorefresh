...
export default function AdminLowestPrices() {
    ...
    const [confirmDeleteLowPriceId, setConfirmDeleteLowPriceId] = useState<string | null>(null);
    ...
    const handleDelete = (id: string) => {
        setConfirmDeleteLowPriceId(id);
    };

    const handleConfirmDeleteLowPrice = async () => {
        if (!confirmDeleteLowPriceId) return;
        const id = confirmDeleteLowPriceId;
        setConfirmDeleteLowPriceId(null);
        try {
    ...
    return (
        <div className="flex flex-col h-full bg-gray-50">
            ...
            {/* Delete Lowest Price Product Confirmation Modal */}
            {confirmDeleteLowPriceId && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    <div className="absolute inset-0 bg-black/50 backdrop-blur-sm" onClick={() => setConfirmDeleteLowPriceId(null)} />
                    <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-2xl relative z-10 text-center">
                        ...
                        <h3 className="text-lg font-semibold text-neutral-800 mb-2">Remove Product</h3>
                        <p className="text-sm text-neutral-500 mb-6">Are you sure you want to remove this product from the lowest prices section?</p>
                        <div className="flex gap-3">
                            <button
                                onClick={() => setConfirmDeleteLowPriceId(null)}
                            ...
                            <button
                                onClick={handleConfirmDeleteLowPrice}
