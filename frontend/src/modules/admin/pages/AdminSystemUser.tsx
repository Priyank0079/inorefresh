...
export default function AdminSystemUser() {
  ...
  const [confirmDeleteSysUserId, setConfirmDeleteSysUserId] = useState<string | null>(null);
  ...
  const handleDelete = (id: string) => {
    setConfirmDeleteSysUserId(id);
  };

  const handleConfirmDeleteSysUser = async () => {
    if (!confirmDeleteSysUserId) return;
    const id = confirmDeleteSysUserId;
    setConfirmDeleteSysUserId(null);
    setLoading(true);
    setError('');
    setSuccessMessage('');
    try {
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50">
      ...
      {/* Delete System User Confirmation Modal */}
      {confirmDeleteSysUserId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-black/50 backdrop-blur-sm" onClick={() => setConfirmDeleteSysUserId(null)} />
          <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-2xl relative z-10 text-center">
            ...
            <h3 className="text-lg font-semibold text-neutral-800 mb-2">Delete System User</h3>
            <p className="text-sm text-neutral-500 mb-6">Are you sure you want to delete this system user? This action cannot be undone.</p>
            <div className="flex gap-3">
              <button
                onClick={() => setConfirmDeleteSysUserId(null)}
              ...
              <button
                onClick={handleConfirmDeleteSysUser}
