        ...
        <div className="flex flex-col h-full bg-gray-50">
            ...
            {confirmDeleteSectionId && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    <div className="absolute inset-0 bg-black/50 backdrop-blur-sm" onClick={() => setConfirmDeleteSectionId(null)} />
                    <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-2xl relative z-10 text-center">
                        ...
                        <h3 className="text-lg font-semibold text-neutral-800 mb-2">Delete Section</h3>
                        <p className="text-sm text-neutral-500 mb-6">Are you sure you want to delete this section? This action cannot be undone.</p>
