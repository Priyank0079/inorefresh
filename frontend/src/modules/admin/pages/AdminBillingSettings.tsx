    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center p-12">
                <div className="w-8 h-8 border-4 border-[#12b2a2] border-t-transparent rounded-full animate-spin"></div>
            </div>
        );
    }
        ...
        >
            <div className="flex justify-between items-center mb-6">
                ...
                <button
                    onClick={handleSave}
                    disabled={saving}
                    className="px-6 py-2.5 bg-[#12b2a2] text-white rounded-lg font-medium hover:bg-[#0e8f82] transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    {saving ? (
                        <>
                    ...
                    <div className="flex justify-between items-start mb-6 pb-2 border-b">
                        ...
                        <div className="flex items-center gap-2 bg-neutral-100 p-1 rounded-lg">
                            ...
                            <button
                                ...
                                className={`px-3 py-1.5 text-sm font-medium rounded-md transition-all ${isDistanceBased ? 'bg-white text-[#12b2a2] shadow-sm' : 'text-gray-500 hover:text-gray-700'
                                    }`}
                            >
                                Distance Based
                            </button>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full pl-4 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-[#12b2a2] focus:border-[#12b2a2]"
                                    />
