...
const menuSections: MenuSection[] = [
  {
    ...
    items: [
        ...
        submenuItems: [
          {
            ...
            path: "/admin/manage-warehouse/list",
            icon: (
              <svg
                width="18"
                height="18"
          ...
          },
          {
            ...
            path: "/admin/manage-warehouse/create",
            icon: (
              <svg
                width="18"
                height="18"
          ...
          {
            label: "Inward Stock",
            path: "/admin/manage-warehouse/inward-stock",
            icon: (
              <svg
                width="18"
                height="18"
      ...
      },
      {
        ...
        submenuItems: [
          {
            label: "Port Negotiations",
            path: "/admin/manage-warehouse/port-negotiations",
            icon: (
          ...
          },
          {
            ...
            path: "/admin/manage-warehouse/port-shipments",
            icon: (
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path>
                <polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline>
        ...
        submenuItems: [
          {
            ...
            path: "/admin/manage-location/warehouse-location",
            icon: (
              <svg
                width="18"
                height="18"
          ...
          },
          {
            ...
            icon: (
              <svg
                ...
                <path d="M6 17V9a4 4 0 0 1 4-4h6"></path>
              </svg>
            ),
          },
          {
