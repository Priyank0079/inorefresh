...
export default function DeliveryBottomNav() {
  ...
  const activeColor = currentTheme.primary[3];
  ...
  const navItems = [
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Grid of 9 squares */}
          <rect x="3" y="3" width="6" height="6" fill={isActive('/delivery') ? activeColor : inactiveColor} />
          <rect x="11" y="3" width="6" height="6" fill={isActive('/delivery') ? activeColor : inactiveColor} />
          <rect x="19" y="3" width="2" height="6" fill={isActive('/delivery') ? activeColor : inactiveColor} />
          <rect x="3" y="11" width="6" height="6" fill={isActive('/delivery') ? activeColor : inactiveColor} />
          <rect x="11" y="11" width="6" height="6" fill={isActive('/delivery') ? activeColor : inactiveColor} />
          <rect x="19" y="11" width="2" height="6" fill={isActive('/delivery') ? activeColor : inactiveColor} />
          <rect x="3" y="19" width="6" height="2" fill={isActive('/delivery') ? activeColor : inactiveColor} />
          <rect x="11" y="19" width="6" height="2" fill={isActive('/delivery') ? activeColor : inactiveColor} />
          <rect x="19" y="19" width="2" height="2" fill={isActive('/delivery') ? activeColor : inactiveColor} />
        </svg>
      ),
    },
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          />
          {/* Speed lines */}
          <path d="M8 10H10M12 10H14" stroke={isActive('/delivery/orders') ? activeColor : inactiveColor} strokeWidth="2" strokeLinecap="round" fill="none" />
        </svg>
      ),
    },
    {
