        ...
        <div className="flex flex-col h-full">
            ...
            <div className="bg-[#12b2a2] text-white p-6 rounded-lg shadow-sm mb-6 flex justify-between items-center transition-all">
                ...
                <div className="flex items-center gap-2 text-sm">
                    <span className="text-teal-50 hover:text-white cursor-pointer font-medium transition-colors">Home</span>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-neutral-200 flex-1 flex flex-col">
                ...
                <div className="p-4 flex flex-col sm:flex-row flex-wrap gap-4 items-start sm:items-center justify-between border-b border-neutral-100">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            onClick={() => {
                                const headers = ['Variation Id', 'Product Id', 'Product Name', 'Warehouse Name', 'Variation', 'Current Stock', 'Status', 'Category'];
                                const csvContent = [
                                    headers.join(','),
                    ...
                    <table className="w-full text-left border-collapse border border-neutral-200">
                        <thead>
                            <tr className="bg-neutral-50 text-xs font-bold text-neutral-800">
                                ...
                                >
                                    <div className="flex items-center justify-between">
                                        Warehouse Name <SortIcon column="Warehouse" />
                                    </div>
                                </th>
                        ...
                        <tbody>
                            {filteredItems.map((item) => (
                                <tr key={item.variationId} className="hover:bg-neutral-50 transition-colors text-sm text-neutral-700">
                                    ...
                                    <td className="p-4 align-middle border border-neutral-200">{item.Warehouse}</td>
