                      ...
                      <tr key={order.id} className="hover:bg-neutral-50 transition-colors">
                        ...
                        <td className="px-3 sm:px-4 md:px-6 py-3">
                          <div className="flex flex-col gap-1">
                            <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full w-fit ${getStatusColor(order.status)}`}>
                              {order.status}
                            </span>
                            {order.route && (
                              <div className="flex items-center gap-1 flex-wrap">
                                <span className="inline-flex px-1.5 py-0.5 text-[10px] font-bold rounded bg-purple-50 text-purple-700 border border-purple-200">
                                  {order.route.routeNumber}
                                </span>
                                <span className="text-[10px] text-neutral-500">
                                  Stop {order.route.stopSequence}
                                </span>
                                {order.route.delivered && (
                                  <span className="inline-flex px-1.5 py-0.5 text-[10px] font-bold rounded bg-green-50 text-green-700 border border-green-200">
                                    {order.route.delivered}
                                  </span>
                                )}
                              </div>
