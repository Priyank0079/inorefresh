...
const WarehouseRefunds = lazy(() => import("./pages/WarehouseRefunds"));
...
const WarehouseStockOverview = lazy(() => import("./pages/WarehouseStockOverview"));
      ...
      <Suspense fallback={<IconLoader forceShow />}>
        <WarehouseLayout>
          <Routes>
            ...
            <Route path="stock-overview" element={<WarehouseStockOverview />} />
            ...
            <Route path="return/refunds" element={<WarehouseRefunds />} />
