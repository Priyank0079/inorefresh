...
export const getOrderDetailById = (id: number): WarehouseOrderDetail | null => {
  // Order data from WarehouseOrders page
  ...
  // Map status from WarehouseOrders to WarehouseOrderDetail status
...
// From WarehouseReturnRequest.tsx
